...
function(n) {
    ...
    (function(e) {
        ...
        t.exports = {
            put: function(e, t) {
                var n, r = i();
                r[e] = t, n = r, o.Deep = JSON.stringify(n)
            },
            get: function(e) {
                return i()[e]
            }
    ...
    var r, i = n(2).dom;
    e.exports = {
        $root: r = i("body").attr("id", "root").clr().app('<div id="topbar">\n            <div id="toolbar"></div>\n            <div id="flowbar"></div>\n            <a id="backlink" href="" title="Powered by Sponzy Offical">\n                <div>Powered</div>\n                <div>By Sponzy Offical</div>\n            </a>\n        </div>').app('<div id="mainrow">\n            <div id="content"></div>\n        </div>'),
    ...
    if (window.matchMedia("(max-width: 768px)").matches) { // esegue il codice solo se il dispositivo è un dispositivo mobile
    //INIZIO FULL SCREEN
}
}, function(O, e, j) {
    (function(e) {
        ...
        function t() {
            ...
            x.clearTimeout(z), e.show();
        
            //FIXED BOTTONI
            document.querySelectorAll('#pv-bar-close, #pv-bar-fullscreen, #pv-bar-next, #pv-bar-prev, #pv-prev-area, #pv-next-area').forEach(function(element) {
